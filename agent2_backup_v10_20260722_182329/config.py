...
CACHE_PATH = Path(os.getenv('AGENT2_CACHE_PATH', str(BASE_DIR / 'data' / 'agent2_v9_cache.json'))).resolve()
...
USER_AGENT = os.getenv('AGENT2_USER_AGENT', 'Mozilla/5.0 (compatible; UnsolvedCaseResearchBot/9.0)').strip()
